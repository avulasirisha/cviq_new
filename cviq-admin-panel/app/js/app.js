...
var App = angular.module('angle', ['ngOnboarding','angular-img-cropper','monospaced.elastic','ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'ui.utils'])
...
App
    ...
    .constant('APP_REQUIRES', {
        ...
        scripts: {
            ...
            'high-chart':         ['vendor/highchart/highcharts.js'],
            ...
            'datepicker':['vendor/bootstrap-datepicker.min.js',
    ...
    ['$rootScope', '$scope', '$state', '$translate', '$window', '$localStorage', '$timeout', 'toggleStateService', 'colors', 'browser', 'cfpLoadingBar', "$cookieStore",
        function ($rootScope, $scope, $state, $translate, $window, $localStorage, $timeout, toggle, colors, browser, cfpLoadingBar, $cookieStore) {
            ...
            $rootScope.$on('$stateChangeSuccess', function (event, toState, toParams, fromState, fromParams) {
                ...
                if(((toState.name == 'page.login') || (toState.name == 'page.register')) && ($cookieStore.get('obj')) )
                {
...
App.controller('SidebarController', ['$rootScope', '$scope', '$state', '$http', '$timeout', 'Utils','$cookieStore',
    function ($rootScope, $scope, $state, $http, $timeout, Utils,$cookieStore) {
        ...
        $scope.loadSidebarMenu = function () {
            ...
            // console.log("$rootScope.type"+$rootScope.type);
            // if( $cookieStore.get('type')==0){
                var menuJson = 'server/sidebar-menu.json';
            // }
            // else if( $cookieStore.get('type')==1){
            //     var menuJson = 'server/sidebar-menu-subadmin.json'
            // }
            // else if( $cookieStore.get('type')==2){
            //     var menuJson = 'server/sidebar-menu-useradmin.json'
            // }
            // else
            // {
            //     var menuJson = 'server/sidebar-menu.json'
...
/**=========================================================
 * Module: elastic text area
 * setting content according to content
 =========================================================*/
...
App.config(function($sceDelegateProvider) {
    $sceDelegateProvider.resourceUrlWhitelist([
        ...
        'http://taximust.s3.amazonaws.com/**'
    ]);

...
App.controller('jobsController', function ($scope, $http, $cookies,$state, $cookieStore, MY_CONSTANT, $timeout,ngDialog,responseCode, filterFilter) {
...
//==========================================================================================================================
    $scope.getcandidates = function(skip,limit){
        ...
        $http({
            method: 'GET',
            url: MY_CONSTANT.url_cviq + '/api/admin/getAllJobsDetail',
            headers:{
            ...
            .success(function(response){
                ...
                var dataArray = [];
                var allList = response.data.jobList;
                ...
                allList.forEach(function (column) {
                    ...
                    d.isActive = column.isActive;
                    d.jobDescription = column.jobDescription;
                    d.jobTitle = column.jobTitle;
                    d.numOfCandidatesApplied = column.numOfCandidatesApplied;

                    
                    d.recruiterName = column.recruiterID.firstName + column.recruiterID.lastName;
                    d.recruiterEmail = column.recruiterID.email;
                    d.recruiterphone = column.recruiterID.phoneNo;
                    
                    d.postedOn = moment(column.postedOn).format('MMM Do YYYY, h:mm a');

                    d.appliedCandidates = column.appliedCandidates;
                    dataArray.push(d);
...
//==========================================================================================================================
    $scope.exportData = function(){
        $http({
            ...
            .success(function(response){
                console.log("jkhkjsdfkjdfjkdsfsfdsf",response);

                var dataArray1 = [];
                var allList1 = response.data.jobList;
                ...
                allList1.forEach(function (column) {
                    ...
                    e.isActive = column.isActive;
                    e.jobDescription = column.jobDescription;
                    e.jobTitle = column.jobTitle;
                    e.numOfCandidatesApplied = column.numOfCandidatesApplied;


                    e.recruiterName = column.recruiterID.firstName + column.recruiterID.lastName;
                    e.recruiterEmail = column.recruiterID.email;
                    e.recruiterphone = column.recruiterID.phoneNo;

                    e.postedOn = moment(column.postedOn).format('MMM Do YYYY, h:mm a');
                ...
                alasql('SELECT * INTO CSV("AllJobsList.csv",{headers:true}) FROM ?',[$scope.exportList]);
            })
...
//==========================================================================================================================
    ...
    $scope.candidatesApplied = function(data){
        console.log(data);
        $scope.candidatesList = data;
        ngDialog.open({
            template: 'candidates_applied',

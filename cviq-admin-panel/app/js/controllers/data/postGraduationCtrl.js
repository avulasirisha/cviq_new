App.controller('PostGraduationController', function ($state,$scope, $modal, $http, $cookies, $cookieStore, MY_CONSTANT, $timeout, ngDialog, responseCode, filterFilter) {
    ...
    $http({
        method:'GET',
        url: MY_CONSTANT.url_cviq + '/api/common/getPostGraduationList'
    })
        .success(function (response) {
            ...
            var dataArray = [];
            var PostGraduationList = response.data;

            PostGraduationList.forEach(function (column) {
                var d = {};
                d.Id = column._id;
...
//==========================================================================================================================
    $scope.exportData = function () {
        ...
        $http({
            ...
            .success(function (response) {
                console.log(response);
                var exportArray = [];
                var PostGraduationList1 = response.data;

                PostGraduationList1.forEach(function (column) {
                    var d = {};
                    d.Id = column._id;
                    d.courseName = column.courseName;
                ...
                alasql('SELECT * INTO CSV("PostGraduationList.csv",{headers:true}) FROM ?', [$scope.exportList]);
            })
    ...
    $scope.updatePostGraduation = function (data) {
    ...
    $scope.updateConfirm = function () {
        ...
        $http({
            method:'PUT',
            url: MY_CONSTANT.url_cviq +'/api/common/updatePostGraduationData',
            headers:{
                'authorization':$cookieStore.get("obj").accessToken,
                'Content-type': 'application/x-www-form-urlencoded'
            },
            data:{
                "postGraduationID": $scope.newdata.Id,
    ...
    $scope.addPostGraduation = function () {
    ...
    $scope.addConfirm = function () {
        ...
        $http({
            method:'POST',
            url: MY_CONSTANT.url_cviq +'/api/common/insertPostGraduationData',
            headers:{
                'authorization':$cookieStore.get("obj").accessToken,
                'Content-type': 'application/x-www-form-urlencoded'
            },

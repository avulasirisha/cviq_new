App.controller('CountryController', function ($state,$scope, $modal, $http, $cookies, $cookieStore, MY_CONSTANT, $timeout, ngDialog, responseCode, filterFilter) {
    ...
    $http({
        ...
        .success(function (response) {
            ...
            pendingList.forEach(function (column) {
                var d = {};
                d.Id = column._id;
                d.countryName = column.countryName;
                d.countryCode = column.countryCode;
...
//==========================================================================================================================
    $scope.exportData = function () {
        ...
        $http({
            ...
            .success(function (response) {
                ...
                alasql('SELECT * INTO CSV("CountryList.csv",{headers:true}) FROM ?', [$scope.exportList]);
            })
    ...
    $scope.updateConfirm = function () {
        ...
        $http({
            method:'PUT',
            url: MY_CONSTANT.url_cviq +'/api/common/updateCountryData',
            headers:{
                'authorization':$cookieStore.get("obj").accessToken,
                'Content-type': 'application/x-www-form-urlencoded'
            },
            data:{
                "countryID": $scope.newdata.Id,
                "countryName":$scope.newdata.countryName,
                "countryCode": $scope.newdata.countryCode
            }
        })
            .success(function(response){
                $scope.addnewData = {};
 ...
 $scope.addCountry = function () {
    ...
    $scope.addConfirm = function () {
        ...
        $http({
            method:'POST',
            url: MY_CONSTANT.url_cviq +'/api/common/insertCountryData',
            headers:{
                'authorization':$cookieStore.get("obj").accessToken,
                'Content-type': 'application/x-www-form-urlencoded'
            },
            data:{
                "countryName":$scope.addnewData.countryName,
                "countryCode": $scope.addnewData.countryCode
            }
        })
            .success(function(response){
                $scope.addnewData = {};

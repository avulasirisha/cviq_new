App.controller('DoctorateController', function ($state,$scope, $modal, $http, $cookies, $cookieStore, MY_CONSTANT, $timeout, ngDialog, responseCode, filterFilter) {
    ...
    $http({
        method:'GET',
        url: MY_CONSTANT.url_cviq + '/api/common/getDoctorateList'
    })
...
//==========================================================================================================================
    $scope.exportData = function () {
        ...
        $http({
            ...
            .success(function (response) {
                ...
                alasql('SELECT * INTO CSV("DoctorateList.csv",{headers:true}) FROM ?', [$scope.exportList]);
            })
    ...
    $scope.updateDoctorate = function (data) {
    ...
    $scope.updateConfirm = function () {
        ...
        $http({
            method:'PUT',
            url: MY_CONSTANT.url_cviq +'/api/common/updateDoctorateData',
            headers:{
                'authorization':$cookieStore.get("obj").accessToken,
                'Content-type': 'application/x-www-form-urlencoded'
            },
            data:{
                "doctorateID": $scope.newdata.Id,
    ...
    $scope.addConfirm = function () {
        ...
        $http({
            method:'POST',
            url: MY_CONSTANT.url_cviq +'/api/common/insertDoctorateData',
            headers:{
                'authorization':$cookieStore.get("obj").accessToken,
                'Content-type': 'application/x-www-form-urlencoded'
            },

...
App.controller('RecruiterInActiveController', function ($rootScope,$scope, $http, $route, $state, $cookies, $cookieStore, MY_CONSTANT, $timeout, ngDialog, responseCode,currency, filterFilter) {
...
//==========================================================================================================================
    ...
    $http({
        method: 'GET',
        url: MY_CONSTANT.url_cviq + '/api/admin/getRecruiterPromoList',
        headers:{
        ...
        .success(function(data){
            ...
            console.log("Promo list",data.data);
            $rootScope.loading = false;
            $scope.mainId = data.data._id;

            var dataArray = [];
            var List = data.data.inActiveCodeList;
...
//==========================================================================================================================
    ...
    $scope.update= function (data) {
        ...
        if($scope.post.date2 == undefined || $scope.post.date2 == 'Invalid Date'){
            ...
            register.append("userType","RECRUITER");

...
App.controller('CandidateInActiveController', function ($rootScope,$scope, $http, $route, $state, $cookies, $cookieStore, MY_CONSTANT, $timeout, ngDialog, responseCode,currency, filterFilter) {
...
//==========================================================================================================================
    ...
    $http({
        ...
        params:{ 'type':'CANDIDATE','isactive':false  }
    })

...
App.controller('RecruiterFaqController', function ($scope, $http, $route, $state, $cookies, $cookieStore, MY_CONSTANT, $timeout, ngDialog, responseCode,currency, filterFilter) {
    ...
    $http({
        method:'GET',
        url: MY_CONSTANT.url_cviq + '/api/admin/getFAQList?userType=RECRUITER',
    })

App.controller('blockedRecruiterController', function ($scope, $http, $cookies,$state, $cookieStore, MY_CONSTANT, $timeout,ngDialog,responseCode, filterFilter) {
...
//==========================================================================================================================
    $scope.getrecruiters = function(skip,limit){
        ...
        $http({
            method: 'GET',
            url: MY_CONSTANT.url_cviq + '/api/admin/getBlockedRecruiterList',
            headers:{
    ...
    $scope.exportData = function(){
        $http({
            ...
            .success(function(response){
                ...
                alasql('SELECT * INTO CSV("BlockedRecruitersList.csv",{headers:true}) FROM ?',[$scope.exportList]);
            })

...
App.controller('allInterviewerController', function ($scope, $http, $cookies,$state, $cookieStore, MY_CONSTANT, $timeout,ngDialog,responseCode, filterFilter) {

    
    console.log("all interviewer ctrl");
...
//==========================================================================================================================
    $scope.getInterviewers = function(skip,limit){
        ...
        $http({
            method: 'GET',
            url: MY_CONSTANT.url_cviq + '/api/admin/getAllInterviewersList',
            headers:{
            ...
            .success(function(response){
                ...
                var dataArray = [];
                var pendingList = response.data.interviewersList;
                ...
                pendingList.forEach(function (column) {
                   // console.log(Object.keys(column).length);   //to find key length in object
                    ...
                    if(column.resumeURL!= null)
                    {
                        d.resumeURL = column.resumeURL;
                    }
                    else{
                        d.resumeURL = undefined;
                    }


                    if(column.certificationURL != null){
                        d.certificationURL = column.certificationURL;
                    }

                    else{
                        d.certificationURL = undefined;
                    }
                    d.title = column.title;
    ...
    $scope.exportData = function(){
        $http({
            ...
            .success(function(response){
                ...
                var dataArray1 = [];
                var index1 = 0;
                var pendingList1 = response.data.interviewersList;
                ...
                alasql('SELECT * INTO CSV("AllInterviewersList.csv",{headers:true}) FROM ?',[$scope.exportList]);
            })

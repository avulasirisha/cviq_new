App.controller('blockedInterviewerController', function ($scope, $http, $cookies,$state, $cookieStore, MY_CONSTANT, $timeout,ngDialog,responseCode, filterFilter) {

    console.log("blocked interviewer ctrl");
    'use strict';
...
//==========================================================================================================================
    $scope.getInterviewers = function(skip,limit){
        ...
        $http({
            method: 'GET',
            url: MY_CONSTANT.url_cviq + '/api/admin/getBlockedInterviewersList',
            headers:{
    ...
    $scope.exportData = function(){
        $http({
            ...
            .success(function(response){
                ...
                var dataArray1 = [];
                var index1 = 0;
                var pendingList1 = response.data.blockedList;
                ...
                alasql('SELECT * INTO CSV("BlockedInterviewersList.csv",{headers:true}) FROM ?',[$scope.exportList]);
            })
...
//==========================================================================================================================
    ...
    $scope.unblockInterviewer = function(id,name){
console.log(id);
       $scope.interviewer_name = name;
       $scope.interviewer_id = id;
        ngDialog.open({
            template: 'unblock_interviewer_modalDialog',
            className: 'ngdialog-theme-default',
            showClose: false,
            scope: $scope
        });
    };
    $scope.confirmUnBlockInterviewer = function(id){

App.controller('TechQuestionBankController', function ($state,$scope, $modal, $http, $cookies, $cookieStore, MY_CONSTANT, $timeout, ngDialog, responseCode, filterFilter) {
        ...
        if(type == 1){
            ...
            $http({
                ...
                .success(function(response){
                    ...
                    console.log(response);
                    var dataArray = [];
                    var functionalList = response.data.technicalQuestions;
...
//==========================================================================================================================
    $scope.exportData = function () {
        ...
        if( $scope.selectedFunctionalName == undefined){
             naam ='TechnicalQuestionListOf'+$scope.selectedIndustryName+'Industry.csv';
        }
        else{
             naam ='TechnicalQuestionListOf'+$scope.selectedIndustryName+'-Industry&'+ $scope.selectedFunctionalName+'-FunctionalArea.csv';
        }

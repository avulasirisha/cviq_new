...
App.controller('allCandidateController', function ($scope, $http, $cookies,$state, $cookieStore, MY_CONSTANT, $timeout,ngDialog,responseCode, filterFilter) {
...
//==========================================================================================================================
    $scope.getcandidates = function(skip,limit){
        ...
        $http({
            method: 'GET',
            url: MY_CONSTANT.url_cviq + '/api/admin/getAllCandidateList',
            headers:{
            ...
            .success(function(response){
                ...
                var dataArray = [];
                var allList = response.data.candidateList;


                localStorage.setItem("profile",JSON.stringify(allList[41]));
                ...
                allList.forEach(function (column) {
                    ...
                    d.updatedAt = moment(column.updatedAt).format('MMM Do YYYY, h:mm a');
    ...
    $scope.exportData = function(){
        $http({
            ...
            .success(function(response){
                ...
                var dataArray1 = [];
                var allList1 = response.data.candidateList;
                ...
                alasql('SELECT * INTO CSV("AllCandidatesList.csv",{headers:true}) FROM ?',[$scope.exportList]);
            })

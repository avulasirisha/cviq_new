...
var App = angular.module('angle', ['ngRoute','angular-svg-round-progressbar','ngSanitize',
    'angular-carousel-3d', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'ui.utils' ,'ngMaterial'])
    .run(["$rootScope", "$state", "$stateParams", '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
        ...
        $rootScope.editingUmProfile = 0;
        //$rootScope.newStateStatus = 0;
        $rootScope.newState = "";
        ...
        // -----------------------------------
        $rootScope.app = {
            name: 'Nurse OnLine Dashboard',
            description: 'Nurse OnLine Base Template',
...
App.run([
    ...
    '$interval',
    '$cookieStore',
    function ($state, $rootScope, $interval, $cookieStore,$scope) {
        $rootScope.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams) {

            console.log(fromState.name);
            console.log(toState.name);
            if($rootScope.editingUmProfile == 1 && toState.name != "app.profile"){

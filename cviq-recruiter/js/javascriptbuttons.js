...
PAYPAL.apps = PAYPAL.apps || {}, function (a) {
    ...
    function f(a) {
        ...
        if (b = a.attributes)for (f = 0, e = b.length; e > f; f++)c = b[f], (d = c.name.match(/^data-option([0-9])([a-z]+)([0-9])?/i)) ? i.push({
            ...
            value: c.value
        }) : (d = c.name.match(/^data-([a-z0-9_]+)(-editable)?/i)) && (h[d[1]] = {value: c.value, isEditable: !!d[2]});
        return g(i, h), h
    }
    ...
    var i = {}, j = "https://{env}.paypal.com/cgi-bin/webscr", k = "https://{env}.paypal.com/webapps/ppint/qrcode?data={url}&pattern={pattern}&height={size}", l = "JavaScriptButton_{type}", m = {
        ...
        th_TH: {
            buynow: "à¸‹à¸·à¹‰à¸­à¸—à¸±à¸™à¸—à¸µ",
            cart: "à¹€à¸žà¸´à¹ˆà¸¡à¸¥à¸‡à¸•à¸°à¸à¸£à¹‰à¸²",
            donate: "à¸šà¸£à¸´à¸ˆà¸²à¸„",
            subscribe: "à¸šà¸­à¸à¸£à¸±à¸šà¸ªà¸¡à¸²à¸Šà¸´à¸",
            paynow: "à¸ˆà¹ˆà¸²à¸¢à¸•à¸­à¸™à¸™à¸µà¹‰",
            item_name: "à¸Šà¸·à¹ˆà¸­à¸ªà¸´à¸™à¸„à¹‰à¸²",
            number: "à¸£à¸«à¸±à¸ªà¸ªà¸´à¸™à¸„à¹‰à¸²",
            amount: "à¸£à¸²à¸„à¸²",
            quantity: "à¸ˆà¸³à¸™à¸§à¸™"
        },
        tr_TR: {
    ...
    if (PAYPAL.apps.ButtonFactory || (i.config = {labels: {}}, i.buttons = {
            buynow: 0,
            cart: 0,
            donate: 0,
            qr: 0,
